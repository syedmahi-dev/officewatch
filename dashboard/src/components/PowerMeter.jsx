...
export function PowerMeter({ usage }) {
  ...
  return (
    <section className="relative overflow-hidden rounded-[28px] border border-[var(--border-subtle)] bg-[var(--surface)] p-6 shadow-[var(--shadow-panel)] backdrop-blur-xl">
      <div
        aria-hidden="true"
        className="absolute -right-16 top-[-4rem] h-48 w-48 rounded-full bg-[var(--glow-primary)] blur-3xl"
      />
      ...
      <div className="relative space-y-6">
        ...
        <div className="grid gap-4 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
          <div className="rounded-[24px] border border-[var(--border-subtle)] bg-[var(--surface-soft)] p-5">
            ...
            <div className="mt-4 flex items-end gap-3 font-numeric">
              ...
              <span className="pb-2 text-lg font-medium text-[var(--text-secondary)]">W</span>
            </div>
            <div className="mt-5 inline-flex items-center gap-2 rounded-full border border-[var(--border-subtle)] bg-[var(--surface-muted)] px-3 py-1.5 text-sm font-medium text-[var(--text-secondary)]">
              <span className="h-2 w-2 rounded-full bg-[var(--accent-strong)] shadow-[0_0_10px_rgba(48,210,135,0.5)]" />
              {loadState}
            </div>
          </div>
          ...
          <div className="grid gap-3">
            <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-soft)] p-4">
              ...
              <p className="mt-3 font-numeric text-3xl font-semibold tracking-[-0.05em] text-[var(--text-primary)]">
                ...
                <span className="ml-2 text-base font-medium text-[var(--text-secondary)]">kWh</span>
              </p>
            </div>
          </div>
        </div>
